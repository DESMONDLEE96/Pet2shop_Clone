	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/product')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_store_product'),
			...
			if ($this->user->hasPermission('access', 'catalog/product')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/vendor_product', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/vendor_product')) {
				$customer[] = array(
					'name'	   => $this->language->get('text_vendor_product'),
					'href'     => $this->url->link('vendor/vendor_product', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'logistic/shipping_courier')) {
				$logistic[] = array(
			...
			if ($this->user->hasPermission('access', 'logistic/shipping_location')) {
				$logistic[] = array(
