...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$sub_orders = $this->model_sale_order->getSubOrders($this->request->get['order_id']);

			foreach($sub_orders as $k => $v) {
				$sub_orders[$k]['products'] = $this->model_sale_order->getSubOrderProducts($v['sub_order_id']);
			}

			$data['sub_orders'] = $sub_orders;
			...
			$data['currency_left'] = $this->currency->getSymbolLeft($order_info['currency_code']);
