...
class ModelSaleOrder extends Model {
	...
	public function getSubOrders($order_id) {
		$query = $this->db->query("SELECT so.*, s.name AS store_name FROM " . DB_PREFIX . "sub_order so LEFT JOIN " . DB_PREFIX . "store s ON so.store_id = s.store_id WHERE order_id = '" . (int)$order_id . "'");
